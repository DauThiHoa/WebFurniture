...
@WebServlet(name = "ProductDetailsListControllerBedroomLamp", value = "/ProductDetailsListControllerBedroomLamp")
public class ProductDetailsListControllerBedroomLamp extends HttpServlet {
    @Override
