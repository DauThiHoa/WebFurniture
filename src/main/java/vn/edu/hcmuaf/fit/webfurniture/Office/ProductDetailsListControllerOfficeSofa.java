...
@WebServlet(name = "ProductDetailsListControllerOfficeSofa", value = "/ProductDetailsListControllerOfficeSofa")
public class ProductDetailsListControllerOfficeSofa extends HttpServlet {
    @Override
