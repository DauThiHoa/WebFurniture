...
@WebServlet(name = "AddProfile", value = "/Add_Profile")
public class AddProfile extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        && !(aboutme.equals(""))) {
            boolean result = ProfileService.getInstance().addProfile(username, email, firstname, lastname,address,city,country,postalcode,aboutme,age,friends,photos,comments,description);
            if (result) {
