...
@WebServlet(name = "ProductDetailsListControllerLivingRoomSofaPillow", value = "/ProductDetailsListControllerLivingRoomSofaPillow")
public class ProductDetailsListControllerLivingRoomSofaPillow extends HttpServlet {
    @Override
