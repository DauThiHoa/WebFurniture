...
@WebServlet(name = "ProductDetailsListControllerLivingRoomTeatable", value = "/ProductDetailsListControllerLivingRoomTeatable")
public class ProductDetailsListControllerLivingRoomTeatable extends HttpServlet {
    @Override
