...
@WebServlet(name = "ProductDetailsListControllerDecorationCarpet", value = "/ProductDetailsListControllerDecorationCarpet")
public class ProductDetailsListControllerDecorationCarpet extends HttpServlet {
    @Override
