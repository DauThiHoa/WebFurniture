...
@WebServlet(name = "ProductDetailsListControllerBedroomPillow", value = "/ProductDetailsListControllerBedroomPillow")
public class ProductDetailsListControllerBedroomPillow extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("NoiThatPhongNgu_GoiNgu.jsp").forward(request, response);
