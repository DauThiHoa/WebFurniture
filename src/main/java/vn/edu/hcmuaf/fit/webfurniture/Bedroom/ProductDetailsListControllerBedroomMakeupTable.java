package vn.edu.hcmuaf.fit.webfurniture.Bedroom;
...
@WebServlet(name = "ProductDetailsListControllerBedroomMakeupTable", value = "/ProductDetailsListControllerBedroomMakeupTable")
public class ProductDetailsListControllerBedroomMakeupTable extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("NoiThatPhongNgu_BanTrangDiem.jsp").forward(request, response);
