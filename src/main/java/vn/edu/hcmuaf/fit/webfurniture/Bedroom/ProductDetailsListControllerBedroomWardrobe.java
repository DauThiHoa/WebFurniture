...
@WebServlet(name = "ProductDetailsListControllerBedroomWardrobe", value = "/ProductDetailsListControllerBedroomWardrobe")
public class ProductDetailsListControllerBedroomWardrobe extends HttpServlet {
    @Override
