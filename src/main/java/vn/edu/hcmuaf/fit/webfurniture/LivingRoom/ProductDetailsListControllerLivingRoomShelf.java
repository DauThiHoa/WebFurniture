...
@WebServlet(name = "ProductDetailsListControllerLivingRoomShelf", value = "/ProductDetailsListControllerLivingRoomShelf")
public class ProductDetailsListControllerLivingRoomShelf extends HttpServlet {
    @Override
