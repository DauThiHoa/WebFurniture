...
@WebServlet(name = "ProductDetailsListControllerDecorationCurtain", value = "/ProductDetailsListControllerDecorationCurtain")
public class ProductDetailsListControllerDecorationCurtain extends HttpServlet {
    @Override
