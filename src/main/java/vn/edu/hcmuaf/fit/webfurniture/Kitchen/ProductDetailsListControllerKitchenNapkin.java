...
@WebServlet(name = "ProductDetailsListControllerKitchenNapkin", value = "/ProductDetailsListControllerKitchenNapkin")
public class ProductDetailsListControllerKitchenNapkin extends HttpServlet {
    @Override
