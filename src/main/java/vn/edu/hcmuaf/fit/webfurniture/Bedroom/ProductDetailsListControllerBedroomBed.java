...
@WebServlet(name = "ProductDetailsListControllerBedroomBed", value = "/ProductDetailsListControllerBedroomBed")
public class ProductDetailsListControllerBedroomBed extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("NoiThatPhongNgu_GiuongNgu.jsp").forward(request, response);
