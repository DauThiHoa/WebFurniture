...
@WebServlet(name = "ProductDetailsListControllerLivingRoomChairSofa", value = "/ProductDetailsListControllerLivingRoomChairSofa")
public class ProductDetailsListControllerLivingRoomChairSofa extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("NoiThatPhongKhach_GheSofa.jsp").forward(request, response);
