...
@WebServlet(name = "ProductDetailsListControllerOfficeLamp", value = "/ProductDetailsListControllerOfficeLamp")
public class ProductDetailsListControllerOfficeLamp extends HttpServlet {
    @Override
