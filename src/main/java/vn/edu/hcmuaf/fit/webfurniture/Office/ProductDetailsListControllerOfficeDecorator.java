...
@WebServlet(name = "ProductDetailsListControllerOfficeDecorator", value = "/ProductDetailsListControllerOfficeDecorator")
public class ProductDetailsListControllerOfficeDecorator extends HttpServlet {
    @Override
