...
@WebServlet(name = "ProductDetailsListControllerKitchenCabinet", value = "/ProductDetailsListControllerKitchenCabinet")
public class ProductDetailsListControllerKitchenCabinet extends HttpServlet {
    @Override
