...
@WebServlet(name = "ProductDetailsListControllerDecorationFlower", value = "/ProductDetailsListControllerDecorationFlower")
public class ProductDetailsListControllerDecorationFlower extends HttpServlet {
    @Override
