...
@WebServlet(name = "ProductDetailsListControllerOfficeDesk", value = "/ProductDetailsListControllerOfficeDesk")
public class ProductDetailsListControllerOfficeDesk extends HttpServlet {
    @Override
