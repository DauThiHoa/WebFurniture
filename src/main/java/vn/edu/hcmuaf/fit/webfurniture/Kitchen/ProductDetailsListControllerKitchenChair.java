...
@WebServlet(name = "ProductDetailsListControllerKitchenChair", value = "/ProductDetailsListControllerKitchenChair")
public class ProductDetailsListControllerKitchenChair extends HttpServlet {
    @Override
