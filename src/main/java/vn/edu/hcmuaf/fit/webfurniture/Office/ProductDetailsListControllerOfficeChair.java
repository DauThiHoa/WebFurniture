...
@WebServlet(name = "ProductDetailsListControllerOfficeChair", value = "/ProductDetailsListControllerOfficeChair")
public class ProductDetailsListControllerOfficeChair extends HttpServlet {
    @Override
