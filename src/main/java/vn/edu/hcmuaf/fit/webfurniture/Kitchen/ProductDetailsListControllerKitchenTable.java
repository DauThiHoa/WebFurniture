...
@WebServlet(name = "ProductDetailsListControllerKitchenTable", value = "/ProductDetailsListControllerKitchenTable")
public class ProductDetailsListControllerKitchenTable extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("kitchen_dinnerTable.jsp").forward(request, response);
