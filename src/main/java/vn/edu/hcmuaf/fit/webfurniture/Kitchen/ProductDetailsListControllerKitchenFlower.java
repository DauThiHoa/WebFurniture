...
@WebServlet(name = "ProductDetailsListControllerKitchenFlower", value = "/ProductDetailsListControllerKitchenFlower")
public class ProductDetailsListControllerKitchenFlower extends HttpServlet {
    @Override
