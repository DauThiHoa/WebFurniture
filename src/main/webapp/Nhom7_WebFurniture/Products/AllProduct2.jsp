...
<div id="layout1">
    ...
    <div id="right">
        ...
        <div id="CacSanPham">
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        ...
                        <img class="anh"
                             src="../ImageProduct/Hoa-huong-duong.webp"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Bình hoa hướng dương để bàn</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="../ImageProduct/ke-goc-di-dong-mau-trang.webp"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Kệ gỗ di động màu trắng</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    ...
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Khung tranh để bàn</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="../ImageProduct/Moc-treo-do-gan-tuong-hinh-de-thuong.webp"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Móc treo đồ hình dễ thương</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="../ImageProduct/moc-treo-do-gia-dinh-gan-tuong.webp"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Móc gán tường </h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh" src="../ImageProduct/Ke-go-de-do-kieu-dang-nho-gon.webp"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Kệ gỗ nhỏ gọn </h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh" src="../ImageProduct/ke-go-treo-tuong-tien-dung.webp"/>

                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten">Kệ gỗ treo tường tiện dụng</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="../ImageProduct/ban_ghe_cafe.jpg"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Bàn ghế cafe</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh" src="../ImageProduct/ban_ghe_cafe1.jpg"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Bàn ghế Cafe BGC71</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh" src="../ImageProduct/Cay_trang_tri.jpg"/>

                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Cây trang trí góc nhà </h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh" src="../ImageProduct/Combo_chau_Korea.jpg"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Combo chậu Korea</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="../ImageProduct/tu_chau_Lavabo.jpeg"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Tủ chậu Lavabo</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh" src="../ImageProduct/guong-led-phun-cat.jpeg"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Gương led phun cat</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="../ImageProduct/chau_rua_korea.jpg"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Chậu rửa </h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh" src="../ImageProduct/Bo-hoa-trang-tri-an-tuong-chat-luong.webp"/>

                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten">Bó hoa trang trí chất lượng</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh" src="../ImageProduct/Bo-hoa-lua.webp"/>

                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Bó hoa bằng lụa</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="../ImageProduct/Binh-hoa-su-trang-tri.webp"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten">Bình hoa sứ trang trí</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="../ImageProduct/Lo-cam-hoa-de-ban-thuy-tinh-trong.webp"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Lọ cắm hoa để bàn thủy tinh</h4>
                        <h4 class="gia"> 150.000đ</h4>
                    </div>
                    <div class="nutgiohang">
                        <a href="../GioHang/GioHang.html">
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="../ImageProduct/tranh-trang-tri-gan-tuong.webp"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Tranh trang trí gắn tường</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="../ImageProduct/bo-tranh-trang-tri-phong-khach.webp"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten">Tranh trang trí phòng khách</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="../Thongtinsanpham_AllProducts/Image_AllProducts/Khung-tranh-trang-tri-de-ban-nghe-thuat-GHS-6485-ava.jpg"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Khung tranh để bàn nghệ thuật </h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="../ImageProduct/Tranh-tuong-nghe-thuat.webp"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Tranh tường nghệ thuật</h4>
        ...
        <div id="themTrangMoi">
            <a href="../Products/AllProducts.html?_ijt=vr4d2hs4v4ons63to8okodjutn&_ij_reload=RELOAD_ON_SAVE">
                <div class="khung1">
