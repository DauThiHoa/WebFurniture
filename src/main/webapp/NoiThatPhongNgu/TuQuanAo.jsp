...
<head>
    ...
    <link rel="stylesheet" href="TuQuanAo.css">
        ...
        <div id="CacSanPham">
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class=" anh "
                             src="Image_NTTTPhongngu/tu-quan-ao-gon-gang-khoa-hoc-1.jpg"/></div>
                    <div class="noiDungDoTrangTri">
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class=" anh "
                             src="Image_NTTTPhongngu/tu-quan-ao-mini-go-4.jpg"/></div>
                    <div class="noiDungDoTrangTri">
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class=" anh"
                             src="Image_NTTTPhongngu/tu-quan-ao-mini-go-5.jpg"/></div>
                    <div class="noiDungDoTrangTri">
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class=" anh "
                             src="Image_NTTTPhongngu/tu-quan-ao-mini-go-don-gian-1.jpg"/></div>
                    <div class="noiDungDoTrangTri">
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class=" anh "
                             src="Image_NTTTPhongngu/tu-quan-ao-mini-nhua-4.jpg"/></div>
                    <div class="noiDungDoTrangTri">
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="Image_NTTTPhongngu/tu-quan-ao-mini-nhua-5.jpg"/></div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten">Tủ quần áo mini</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh" src="Image_NTTTPhongngu/tu-dung-quan-ao-mini-co-khoa-2.jpg"/>
                    </div>
                    <div class="noiDungDoTrangTri">
