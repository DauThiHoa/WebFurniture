...
<head>
    ...
    <link rel="stylesheet" href="LivingRoom_sofaPillow.css">
...
<div id="layout1">
    <div id="left">
        ...
        <form action="ColorLivingRoomSofaPillow" method="post">
            <div class="mauSac">
                <div class="khung">
        ...
        <form action="SearchLivingRoomSofaPillow" method="post">
    ...
    || p.id == 'g7' || p.id == 'g8' || p.id == 'g9' || p.id == 'g10' || p.id == 'g11' || p.id == 'g12' || p.id == 'g13' || p.id == 'g14'
     || p.id == 'g15' || p.id == 'g16' || p.id == 'g17' || p.id == 'g18'|| p.id == 'g19'|| p.id == 'g20'}" >
                    <div class="sanPham">
...
<div id="layout7" style="margin-top: -500px">
    <div class="thanhDuoi">
        <div class="tenWeb">
...
<script>
    ...
    function clickTren2501000() {
        getColor.style.display = "none";
        layout7.style.marginTop = "-1550px";
        az.style.display = "none";
        ClassSanPham.style.display = "none";
        za.style.display = "none";
        priceaz.style.display = "none";
