...
<head>
    ...
    <link rel="stylesheet" href="BanTra.css">
...
<div id="khungTinTuc">
    <div id="tenTinTuc">
        <h2 class="trangChu_TinTuc"> Trang Chủ / Danh mục sản phẩm / Nội thất phòng khách / Bàn trà </h2>
    </div>
</div>
...
<div id="layout1">
    ...
    <div id="right">
        <div id="CacLoaiDoTrangTri">
            ...
            <div class="loai1">
                <a href="../NoiThatPhongKhach/BanTra.html?_ijt=fk2t0r4e54mbcbqcu89nrkltgm&_ij_reload=RELOAD_ON_SAVE">
            ...
            <div class="loai">
                <a href="../NoiThatPhongKhach/GheSofa.html?_ijt=fk2t0r4e54mbcbqcu89nrkltgm&_ij_reload=RELOAD_ON_SAVE">
                    <img class="anh" src="../ImageProduct/Sofa_nau_co_dien.jpg"/>
                    <h3 class="tenLoaiDoTrangTri">Ghế Sofa</h3>
                </a>
            </div>
            <div class="loai">
                <a href="../NoiThatPhongKhach/KeTivi.html?_ijt=5ru345jeipunuhl7u90o1a1ns8&_ij_reload=RELOAD_ON_SAVE">
            ...
            <div class="loai">
                <a href="../NoiThatPhongKhach/GoiSofa.html?_ijt=5a9ujc352almkagjduojj3h8io&_ij_reload=RELOAD_ON_SAVE">
                    <img class="anh" src="../NoiThatDoTrangTri/Image_DoTrangTri/loaiDoTrangTri4.PNG"/>
                    <h3 class="tenLoaiDoTrangTri">Gối sofa</h3>
                </a>
            </div>
            <div class="loai2">
                <a href="../NoiThatPhongKhach/RemCua.html?_ijt=5a9ujc352almkagjduojj3h8io&_ij_reload=RELOAD_ON_SAVE">
        ...
        <div id="CacSanPham">
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class=" anh "
                             src="Image_NTTTPhongkhach/ban-sofa.webp"/></div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Bàn trà sofa </h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class=" anh "
                             src="Image_NTTTPhongkhach/ban-sofa-dep-2.jpg"/></div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten">Bàn trà sofa phòng khách </h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class=" anh "
                             src="Image_NTTTPhongkhach/ban-tra.png"/></div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Bàn trà đơn giản</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class=" anh "
                             src="Image_NTTTPhongkhach/ban-tra-sofa.jpg"/></div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Bàn trà tròn </h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh "
                                 src="Image_NTTTPhongkhach/ban-tra-sofa-tien-ich.jpg"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Bàn trà sofa tiện ích </h4>
                            <h4 class="gia"> 1.500.000đ</h4>
                            <div class="nutgiohang" style="margin-left: 0%">
                                <a href="../GioHang/GioHang.html">
                                    <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh "
                                 src="Image_NTTTPhongkhach/mau-ban-tra.jpg"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Bàn trà thiết kế</h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh"
                                 src="Image_NTTTPhongkhach/nha-dep_ban-uong-tra.jpg"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Bàn trà phong cách hiện đại </h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh"
                                 src="Image_NTTTPhongkhach/Ban-tra-dien.jpg"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Bàn trà điện đa năng hình rồng </h4>
