...
<div id="layout1">
    <div id="left">
        ...
        <form action="ColorKitchen" method="post">
            <div class="mauSac">
                <div class="khung">
        ...
        <form action="SearchKitchen" method="post">
    ...
    <div id="right">
        ...
        <div class="getColor" id="CacSanPham" style="display: ${none}">
            ...
            <c:forEach var="p" items="${getColor}">
                <c:if test="${p.id == 's1' || p.id == 's2' || p.id == 's3' || p.id == 's4' || p.id == 's5' || p.id == 's6'
    || p.id == 's7' || p.id == 's8' || p.id == 's9' || p.id == 's10' || p.id == 's11' || p.id == 's12'
    ||  p.id == 's13' || p.id == 's14' || p.id == 's15' || p.id == 's16' || p.id == 's17' || p.id == 's18'
    || p.id == 's19' || p.id == 's20' || p.id == 's21' || p.id == 's22' || p.id == 's23' || p.id == 's24'}" >
                    <div class="sanPham">
    ...
    || p.id == 's19' || p.id == 's20' || p.id == 's21' || p.id == 's22' || p.id == 's23' || p.id == 's24'}" >
        ...
        <div class= "ClassSanPham" id="CacSanPham" style="display: ${block}" >
            <jsp:useBean id="productDetailsKitchen" scope="request" type="java.util.List"/>
            <c:forEach var="p" items="${productDetailsKitchen}">
                <c:if test="${p.id == 's1' || p.id == 's2' || p.id == 's3' || p.id == 's4' || p.id == 's5' || p.id == 's6'
    || p.id == 's7' || p.id == 's8' || p.id == 's9' || p.id == 's10' || p.id == 's11' || p.id == 's12'
    ||  p.id == 's13' || p.id == 's14' || p.id == 's15' || p.id == 's16' || p.id == 's17' || p.id == 's18'
    || p.id == 's19' || p.id == 's20' || p.id == 's21' || p.id == 's22' || p.id == 's23' || p.id == 's24'}" >
