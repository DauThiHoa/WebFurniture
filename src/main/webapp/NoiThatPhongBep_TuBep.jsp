...
<div id="layout1">
    <div id="left">
        ...
        <form action="ColorKitchenCabinet" method="post">
            <div class="mauSac">
                <div class="khung">
        ...
        <form action="SearchKitchenCabinet" method="post">
    ...
    <div id="right">
        ...
        <div class="getColor" id="CacSanPham" style="display: ${none}">
            ...
            <c:forEach var="p" items="${getColor}">
                <c:if test="${ p.id == 's13' || p.id == 's18' || p.id == 's19' || p.id == 's20' || p.id == 's21'
    || p.id == 's22' || p.id == 's23' || p.id == 's24' }" >
                    <div class="sanPham">
