...
<div id="layout6">
    ...
    <div class="meoVatHay">
        <div class="meoVat1">
            <!--            <img class="anh" src="../Home/Image/hethong.png" style="height: 400px; width: 450px"/>-->
            <iframe class="anh"
        ...
        <div class="meoVat">
            <div>
                <h2 class="ten"> Hệ thống cửa hàng của ND Nội Thất trên toàn quốc </h2>
                ...
                <p class="noiDung"> -Địa chỉ: Tầng 4, tòa nhà Flemington, số 182, đường Lê Đại Hành, phường 15, quận 11,
                    Tp. Hồ Chí Minh.</p>
