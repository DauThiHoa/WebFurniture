...
<head>
    ...
    <link rel="stylesheet" href="kitchen_tablecloths.css">
...
<div id="layout1">
    <div id="left">
        ...
        <form action="ColorKitchenNapkin" method="post">
            <div class="mauSac">
                <div class="khung">
        ...
        <form action="SearchKitchenNapkin" method="post">
