...
<%--                    </form>--%>
<%--                </td>--%>
                    <td><input type="text" name ="name" style=" border: 1px solid #f8f9fe ; background: #f8f9fe"  value="hh"></td>
                    <td><input type="text" name ="dateOrder" style=" border: 1px solid #f8f9fe ; background: #f8f9fe"  value="hh"></td>
                    <td><input type="text" name ="dateReceipt" style=" border: 1px solid #f8f9fe ; background: #f8f9fe"  value="hh"></td>
                    <td class="chiTiet"><input type="text" name ="totalMoney" style=" border: 1px solid #f8f9fe ; background: #f8f9fe"  value="hh"></td>
                    <td><input type="text" name ="bank" style=" border: 1px solid #f8f9fe ; background: #f8f9fe"  value="hh"></td>
                    <td class="DangGiao"><input type="text" name ="status" style=" border: 1px solid #f8f9fe ; background: #f8f9fe"  value="hh"></td>
                    <td>
                        <input type="hidden" style="display: none" name ="idOrder" value="hh">
                        <button style="border: 1px solid white ; background: #f8f9fe  ; color: #1fb5d4" type="submit" href="" class="fa fa-edit" onclick="edit()" aria-hidden="true" ></button>
                    </td>
                </form>
                <td>
                    <form action = "<%=Asset.url("RemoveOrder")%>"  method = "POST" >
                        <input type="hidden" name ="id" value="hh">
                        <button style="border: 1px solid white ; background: #f8f9fe " type="submit" href="" class="fa fa-trash text-danger" onclick="trash()"
                                aria-hidden="true" ></button>
                    </form>
                </td>
