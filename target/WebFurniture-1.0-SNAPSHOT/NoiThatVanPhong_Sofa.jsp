...
<head>
    ...
    <link rel="stylesheet" href="NoiThatVanPhong_Sofa.css">
    ...
    <div id="right">
        ...
        <div class="getColor" id="CacSanPham" style="display: ${none}">
            ...
            <c:forEach var="p" items="${getColor}">
                <c:if test="${p.id == 'vp20' || p.id == 'vp21' || p.id == 'sp53' || p.id == 'sp55' }" >
                    <div class="sanPham">
        ...
        <div id="CacSanPham">
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="NoiThatVanPhong/Image_vanphong/ghe-sofa-van-phong-vp01-5-.jpg"/></div>
                    <div class="noiDungDoTrangTri">
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="NoiThatVanPhong/Image_vanphong/sofa-van-phong.jpg"/></div>
                    <div class="noiDungDoTrangTri">
