...
<head>
    ...
    <link rel="stylesheet" href="NoiThatVanPhong_DenLamViec.css">
...
<div id="layout1">
    <div id="left">
        ...
        <form action="ColorOfficeLamp" method="post">
            <div class="mauSac">
                <div class="khung">
        ...
        <form action="SearchOfficeLamp" method="post">
    ...
    <div id="right">
        ...
        <div class="getColor" id="CacSanPham" style="display: ${none}">
            ...
            <c:forEach var="p" items="${getColor}">
                <c:if test="${p.id == 'vp7' || p.id == 'vp8' || p.id == 'vp9' || p.id == 'vp10' || p.id == 'vp11' || p.id == 'vp12' || p.id == 't1' }" >
                    <div class="sanPham">
        ...
        <div id="CacSanPham">
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh" src="NoiThatVanPhong/Image_vanphong/den-de-ban.jpg" height="397" width="450"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Đèn để bàn làm việc</h4>
