...
<div id="layout1">
    <div id="left">
        ...
        <form action="ColorBedroom" method="post">
            <div class="mauSac">
                <div class="khung">
        ...
        <form action="SearchBedroom" method="post">
    ...
    <div id="right">
        ...
        <div class="getColor" id="CacSanPham" style="display: ${none}">
            ...
            <c:forEach var="p" items="${getColor}">
                <c:if test="${p.id == 'n1' || p.id == 'n2' || p.id == 'sp61' || p.id == 'n3' || p.id == 'n4' || p.id == 'n5'
    || p.id == 'n6' || p.id == 'sp81' || p.id == 'sp80' || p.id == 'sp82' || p.id == 'sp84' || p.id == 'n7'
    ||  p.id == 'n8' || p.id == 'sp79' || p.id == 'n9' || p.id == 'n10' || p.id == 'n11' || p.id == 'n12'
    || p.id == 'n13' || p.id == 'n14' || p.id == 'n15' || p.id == 'n16' || p.id == 'n17' || p.id == 'n18'}" >
                    <div class="sanPham">
