...
<div id="layout1">
    ...
    <div id="right">
        <div id="CacLoaiDoTrangTri">
            ...
            <div class="loai">
                <a href="../NoiThatVanPhong/BanLamViec.html?_ijt=afedu4rmvu71rltpdugkadgo4l&_ij_reload=RELOAD_ON_SAVE">
            ...
            <div class="loai">
                <a href="../NoiThatVanPhong/Ghe.html?_ijt=afedu4rmvu71rltpdugkadgo4l&_ij_reload=RELOAD_ON_SAVE">
            ...
            <div class="loai">
                <a href="../NoiThatVanPhong/Sofa.html?_ijt=k085o4525afcc1aaffmng95bir&_ij_reload=RELOAD_ON_SAVE">
                    <img class="anh"
            ...
            <div class="loai1">
                <a href="../NoiThatVanPhong/DenLamViec.html?_ijt=k085o4525afcc1aaffmng95bir&_ij_reload=RELOAD_ON_SAVE">
            ...
            <div class="loai">
                <a href="../NoiThatVanPhong/TrangTri.html?_ijt=k085o4525afcc1aaffmng95bir&_ij_reload=RELOAD_ON_SAVE">
        ...
        <div id="CacSanPham">
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="../NoiThatVanPhong/Image_vanphong/ban-ghe-phong-hop.jpg"/></div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Bàn ghế phòng họp</h4>
                        <h4 class="gia"> 7.400.000đ</h4>
                    </div>
                    <div class="nutgiohang">
                        <a href="../GioHang/GioHang.html">
                            <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="../NoiThatVanPhong/Image_vanphong/ban-ghe-phong-hop1.jpg"/></div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Bàn ghế phòng họp</h4>
                        <h4 class="gia"> 9.150.000đ</h4>
                    </div>
                    <div class="nutgiohang">
                        <a href="../GioHang/GioHang.html">
                            <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="../NoiThatVanPhong/Image_vanphong/ban-lam-viec-chu-l-chan-sat.jpg"/></div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Bàn làm việc chữ L</h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh"
                             src="../NoiThatVanPhong/Image_vanphong/ban-phong-hop2.jpg"/></div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Bàn phòng họp </h4>
                        <h4 class="gia"> 5.220.000đ</h4>
                    </div>
                    <div class="nutgiohang">
                        <a href="../GioHang/GioHang.html">
                            <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh"
                                 src="../NoiThatVanPhong/Image_vanphong/ban-van-phong.jpg"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Bàn làm việc văn phòng</h4>
                            <h4 class="gia"> 2.080.000đ</h4>
                        </div>
                        <div class="nutgiohang">
                            <a href="../GioHang/GioHang.html">
                                <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh"
                                 src="../NoiThatVanPhong/Image_vanphong/ban-van-phong-go.jpg"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Bàn làm việc cá nhân</h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh"
                                 src="../NoiThatVanPhong/Image_vanphong/den-bàn-lam-viec.jpg"/>
                        </div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Đèn để bàn làm việc</h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh"
                                 src="../ImageProduct/Den_de_ban.jpg"/></div>
                        <div class="noiDungDoTrangTri">
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh" src="../NoiThatVanPhong/Image_vanphong/den-de-ban.jpg" height="397"
                                 width="450"/>
                        </div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Đèn để bàn làm việc</h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh" src="../NoiThatVanPhong/Image_vanphong/den-de-ban-den-ban-lam.png"/>
                        </div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Đèn để bàn làm việc</h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh" src="../NoiThatVanPhong/Image_vanphong/den-lam-viec.png"/>
                        </div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Đèn để bàn làm việc dễ thương</h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh"
                                 src="../NoiThatVanPhong/Image_vanphong/den-led-de.jpg"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Đèn led</h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh" src="../NoiThatVanPhong/Image_vanphong/dong-ho-treo-tuong.jpg"/>
                        </div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Đồng hồ treo tường </h4>
                            <h4 class="gia"> 470.000đ</h4>
                        </div>
                        <div class="nutgiohang">
                            <a href="../GioHang/GioHang.html">
                                <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh" src="../NoiThatVanPhong/Image_vanphong/dongho.jpg"/>
                        </div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten">Đồng hồ treo tường</h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh"
                                 src="../NoiThatVanPhong/Image_vanphong/dèn.jpg"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Đèn bàn làm việc</h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh" src="../NoiThatVanPhong/Image_vanphong/ghe-ngu-trua-van-phong.jpg"/>
                        </div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Ghế ngủ trưa văn phòng</h4>
                            <h4 class="gia"> 580.000đ</h4>
                        </div>
                        <div class="nutgiohang">
                            <a href="../GioHang/GioHang.html">
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh"
                                 src="../NoiThatVanPhong/Image_vanphong/ghe-truong-phong.jpg"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Ghế xoay văn phòng</h4>
                            <h4 class="gia"> 580.000đ</h4>
                        </div>
                        <div class="nutgiohang">
                            <a href="../GioHang/GioHang.html">
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh" src="../NoiThatVanPhong/Image_vanphong/Ghe-van-phong.jpg"/>
                        </div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Ghế văn phòng</h4>
                            <h4 class="gia"> 700.000đ</h4>
                        </div>
                        <div class="nutgiohang">
                            <a href="../GioHang/GioHang.html">
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh" src="../NoiThatVanPhong/Image_vanphong/Ghe-van-phong-HALL.jpg"/>
                        </div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten">Ghế văn phòng Hall</h4>
                            <h4 class="gia"> 400.000đ</h4>
                        </div>
                        <div class="nutgiohang">
                            <a href="../GioHang/GioHang.html">
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh" src="../NoiThatVanPhong/Image_vanphong/ghe-van-phong-sofa.jpg"/>
                        </div>
                        <div class="noiDungDoTrangTri">
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh"
                                 src="../NoiThatVanPhong/Image_vanphong/ghe-van-phong-sofa1.jpg"/></div>
                        <div class="noiDungDoTrangTri">
