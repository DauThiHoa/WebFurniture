...
<head>
    ...
    <link rel="stylesheet" href="kitchen_dinnerTable.css">
...
<div id="layout1">
    <div id="left">
        <div class="khung">
            ...
            <div class="noiDung">
                ...
                <a href="Office.jsp?_ijt=u02dapo0848viiovmlb2f3u0eo&_ij_reload=RELOAD_ON_SAVE">
                    <div class="noiThat">
        ...
        <form action="ColorKitchenTable" method="post">
            <div class="mauSac">
                <div class="khung">
        ...
        <form action="SearchKitchenTable" method="post">
    ...
    || p.id == 's7' || p.id == 's43' || p.id == 's44' || p.id == 's16' }" >
                    <div class="sanPham">
