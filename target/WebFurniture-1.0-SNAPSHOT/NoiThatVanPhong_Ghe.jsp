...
<head>
    ...
    <link rel="stylesheet" href="NoiThatVanPhong_Ghe.css">
...
<div id="layout1">
    <div id="left">
        <div class="khung">
            ...
            <div class="noiDung">
                <a href="ProductDetailsListLivingRoomf">
                    <div class="noiThat">
    ...
    <div id="right">
        ...
        <div class="getColor" id="CacSanPham" style="display: ${none}">
            ...
            <c:forEach var="p" items="${getColor}">
                <c:if test="${p.id == 'vp16' || p.id == 'vp17' || p.id == 'vp18' || p.id == 'vp19' || p.id == 'vp22' || p.id == 'vp23' }" >
                    <div class="sanPham">
...
<%--
        <div id="CacSanPham">
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh" src="NoiThatVanPhong/Image_vanphong/ghế-xoay.jpg"/>
                    </div>
                    <div class="noiDungDoTrangTri">
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class="anh" src="NoiThatVanPhong/Image_vanphong/Ghế-xoay-văn-phòng-GVP002-2.jpg"/>
                    </div>
                    <div class="noiDungDoTrangTri">
