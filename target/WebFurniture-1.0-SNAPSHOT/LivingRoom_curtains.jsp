...
<head>
    ...
    <link rel="stylesheet" href="LivingRoom_curtains.css">
...
<div id="layout1">
    <div id="left">
        ...
        <form action="ColorLivingRoomCurtain" method="post">
            <div class="mauSac">
                <div class="khung">
        ...
        <form action="SearchLivingRoomCurtain" method="post">
    ...
    || p.id == 'r7' || p.id == 'r8' || p.id == 'r9' || p.id == 'r10' }" >
                    <div class="sanPham">
