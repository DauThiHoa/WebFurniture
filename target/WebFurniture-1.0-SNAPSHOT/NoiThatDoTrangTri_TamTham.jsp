...
<head>
    ...
    <link rel="stylesheet" href="NoiThatDoTrangTri_TamTham.css">
...
<div id="khungTinTuc">
    <div id="tenTinTuc">
        <h2 class="trangChu_TinTuc"> Trang Chủ / Danh mục sản phẩm / Nội thất đồ trang trí / Tấm thảm </h2>
    </div>
</div>
...
<div id="layout1">
    <div id="left">
        ...
        <form action="ColorDecoratorCarpet" method="post">
            <div class="mauSac">
                <div class="khung">
        ...
        <form action="SearchDecoratorCarpet" method="post">
    ...
    <div id="right">
        <div id="CacLoaiDoTrangTri">
            ...
            <a href="ProductDetailsListControllerDecorationFlower">
                <div class="loai">
        ...
        <div class="getColor" id="CacSanPham" style="display: ${none}">
            ...
            <c:forEach var="p" items="${getColor}">
                <c:if test="${p.id == 'th1' || p.id == 'th2' || p.id == 'th3' || p.id == 'th4' || p.id == 'th5' || p.id == 'th6'
    || p.id == 'th7' || p.id == 'th8' || p.id == 'th9' || p.id == 'th10' || p.id == 'th11' || p.id == 'th12'
    ||  p.id == 'th13' || p.id == 'th14' || p.id == 'th15' || p.id == 'th16' || p.id == 'th17' || p.id == 'th18'
    || p.id == 'th19' || p.id == 'th20' || p.id == 'th21' || p.id == 'th22' || p.id == 'th23' || p.id == 'th24'}" >
                    <div class="sanPham">
...
<%--
        <div id="CacSanPham">
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class=" anh" src="NoiThatDoTrangTri/Image_ThamTam/tham1.webp"/></div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Thảm lông ngắn GHO-301</h4>
                        <h4 class="gia"> 2.390.000đ</h4>
                        <div class="nutgiohang" style="margin-left: 0%">
                            <a href="GioHang.jsp">
                                <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                                        data-id="1050379730"><i class="fa fa-cart-plus"
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class=" anh " src="NoiThatDoTrangTri/Image_ThamTam/tham2.webp"/></div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Thảm lông ngắn GHO-308 </h4>
                        <h4 class="gia"> 2.000.000đ</h4>
                        <div class="nutgiohang" style="margin-left: 0%">
                            <a href="GioHang.jsp">
                                <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                                        data-id="1050379730"><i class="fa fa-cart-plus"
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class=" anh " src="NoiThatDoTrangTri/Image_ThamTam/tham3.webp"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Thảm lông ngắn trải sàn phòng ăn GHO-36664 </h4>
                        <h4 class="gia"> 2.000.000đ</h4>
                        <div class="nutgiohang" style="margin-left: 0%">
                            <a href="GioHang.jsp">
                                <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class=" anh " src="NoiThatDoTrangTri/Image_ThamTam/tham4.webp"/></div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Thảm nhập khẩu giá rẻ GHO-C05 </h4>
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class=" anh " src="NoiThatDoTrangTri/Image_ThamTam/tham5.webp"/></div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Thảm trải sàn đẹp giá rẻ GHO-37053 </h4>
                        <h4 class="gia"> 1.600.000đ</h4>
                        <div class="nutgiohang" style="margin-left: 0%">
                            <a href="GioHang.jsp">
                                <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                                        data-id="1050379730"><i class="fa fa-cart-plus"
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class=" anh " src="NoiThatDoTrangTri/Image_ThamTam/tham6.webp"/></div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Thảm trải sàn đẹp nhập khẩu GHO-36450 </h4>
                        <h4 class="gia"> 3.980.000đ</h4>
                        <div class="nutgiohang" style="margin-left: 0%">
                            <a href="GioHang.jsp">
                                <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                                        data-id="1050379730"><i class="fa fa-cart-plus"
            ...
            <div class="sanPham">
                <div class="sanPhamNoiThat">
                    <div class="anhDoTrangTri">
                        <img class=" anh " src="NoiThatDoTrangTri/Image_ThamTam/tham7.webp"/>
                    </div>
                    <div class="noiDungDoTrangTri">
                        <h4 class="ten"> Thảm trải sàn họa tiết hình học GHO-C07 </h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh " src="NoiThatDoTrangTri/Image_ThamTam/tham8.webp"/>
                        </div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Thảm trải sàn dành cho bé nam chơi GHO-331 </h4>
                            <h4 class="gia"> 2.980.000đ</h4>
                            <div class="nutgiohang" style="margin-left: 0%">
                                <a href="GioHang.jsp">
                                    <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                                            data-id="1050379730"><i class="fa fa-cart-plus"
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh " src="NoiThatDoTrangTri/Image_ThamTam/tham9.webp"/>
                        </div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Thảm nằm chơi cho bé cotton chần bông GHO-325 </h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh" src="NoiThatDoTrangTri/Image_ThamTam/tham10.webp"/>
                        </div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten">Thảm chơi cho bé chất liệu cotton chần bông GHO-324</h4>
                            <h4 class="gia"> 989.000đ</h4>
                            <div class="nutgiohang" style="margin-left: 0%">
                                <a href="GioHang.jsp">
                                    <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                                            data-id="1050379730"><i class="fa fa-cart-plus"
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class="anh" src="NoiThatDoTrangTri/Image_ThamTam/tham11.webp"/>
                        </div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Thảm chơi cho bé in hình hai mặt dễ thương GHO-335</h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh" about="" src="NoiThatDoTrangTri/Image_ThamTam/tham12.webp"/>
                        </div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Thảm chơi cho bé thiết kế in hình dễ thương GHO-332</h4>
                            <h4 class="gia"> 900.000 đ</h4>
                            <div class="nutgiohang" style="margin-left: 0%">
                                <a href="GioHang.jsp">
                                    <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                                            data-id="1050379730"><i class="fa fa-cart-plus"
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh " src="NoiThatDoTrangTri/Image_ThamTam/tham13.webp"/>
                        </div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten">Thảm trải sàn xốp XPE 2 mặt phủ Silicone GHO-320</h4>
                            <h4 class="gia"> 1.200.000đ</h4>
                            <div class="nutgiohang" style="margin-left: 0%">
                                <a href="GioHang.jsp">
                                    <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh " src="NoiThatDoTrangTri/Image_ThamTam/tham14.webp"/>
                        </div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Thảm trải sàn lông cho phòng khách GHO-31093 </h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh " src="NoiThatDoTrangTri/Image_ThamTam/tham15.PNG"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten">Thảm XPE đa năng chống thấm 2 mặt dành cho bé </h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh " src="NoiThatDoTrangTri/Image_ThamTam/tham16.PNG"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten">Thảm XPE chống thấm họa tiết ngộ nghĩnh dành cho bé </h4>
                            <h4 class="gia"> 900.000đ </h4>
                            <div class="nutgiohang" style="margin-left: 0%">
                                <a href="GioHang.jsp">
                                    <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh " src="NoiThatDoTrangTri/Image_ThamTam/tham17.PNG"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Thảm xốp silicon XPE nằm chơi cho bé GHO-319 </h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh" src="NoiThatDoTrangTri/Image_ThamTam/tham18.PNG"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Thảm chơi cho bé chống thấm 2 mặt GHO-322 </h4>
                            <h4 class="gia"> 900.000đ</h4>
                            <div class="nutgiohang" style="margin-left: 0%">
                                <a href="GioHang.jsp">
                                    <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh " src="NoiThatDoTrangTri/Image_ThamTam/tham19.PNG"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Thảm xốp silicon XPE đa năng dành cho bé GHO-321 </h4>
                            <h4 class="gia"> 989.000đ </h4>
                            <div class="nutgiohang" style="margin-left: 0%">
                                <a href="GioHang.jsp">
                                    <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh " src="NoiThatDoTrangTri/Image_ThamTam/tham20.PNG"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Thảm trải sàn xốp XPE 2 mặt phủ Silicon GHO-320 </h4>
                            <h4 class="gia">900.000đ</h4>
                            <div class="nutgiohang" style="margin-left: 0%">
                                <a href="GioHang.jsp">
                                    <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh " src="NoiThatDoTrangTri/Image_ThamTam/tham21.PNG"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Thảm lông trải sàn cao cấp nhập khẩu GHX-307 </h4>
                            <h4 class="gia"> 3.600.000đ </h4>
                            <div class="nutgiohang" style="margin-left: 0%">
                                <a href="GioHang.jsp">
                                    <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                                            data-id="1050379730"><i class="fa fa-cart-plus"
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh" src="NoiThatDoTrangTri/Image_ThamTam/tham22.PNG"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten">Thảm trải sàn sợi lông ngắn cao cấp GHX-305</h4>
                            <h4 class="gia"> 1.900.000đ</h4>
                            <div class="nutgiohang" style="margin-left: 0%">
                                <a href="GioHang.jsp">
                                    <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                                            data-id="1050379730"><i class="fa fa-cart-plus"
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh" src="NoiThatDoTrangTri/Image_ThamTam/tham23.PNG"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Thảm lông ngắn Thổ Nhĩ Kỳ hiện đại GHX-305</h4>
                ...
                <div class="sanPham">
                    <div class="sanPhamNoiThat">
                        <div class="anhDoTrangTri">
                            <img class=" anh" src="NoiThatDoTrangTri/Image_ThamTam/tham24.PNG"/></div>
                        <div class="noiDungDoTrangTri">
                            <h4 class="ten"> Thảm trải sàn nhà cửa ra vào sợi bông siêu thấm </h4>
                            <h4 class="gia"> 500.000đ </h4>
                            <div class="nutgiohang" style="margin-left: 0%">
                                <a href="GioHang.jsp">
                                    <button type="button" class="btnAddToCart add-to-cart medium--hide small--hide"
                                            data-id="1050379730"><i class="fa fa-cart-plus"
