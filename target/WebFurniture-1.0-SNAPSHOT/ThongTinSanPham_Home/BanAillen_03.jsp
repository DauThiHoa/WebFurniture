...
<div id="Thanh_cong_cu">
    ...
    <div id="TaiKhoan">
        <a href="../DangNhap/Login.html?_ijt=ub6fnn290t0r87knge44glhgdr">
            <div>
        ...
        <div id="dangNhap_dangKy">
            <p class="danhNhap"><a
                    href="../DangNhap/Login.html?_ijt=ub6fnn290t0r87knge44glhgdr">Đăng
                nhập </a>
            <p class="cheo">/</p> <a
                href="../DangKy/Register.html?_ijt=ub6fnn290t0r87knge44glhgdr"><p
...
<div id="thongTinSanPham">
    <div class="trai">
        <div id="anhDau">
            <img id="anh" class="anh_BanLamViec" src="../Home/Image/BanAillen03_SPH.PNG"/>
        </div>
        <img id="anhDau1" class="anh_BanLamViec_min" src="../Home/Image/BanAillen03_SPH.PNG" onclick="zoomount(this)"
             alt="image"/>
    ...
    <div class="phai">
        ...
        <div class="mauSac">
            ...
            <div class="bottom">
                <img class="anh_BanLamViec_min" src="../Home/Image/BanAillen03_SPH.PNG" onclick="zoomount(this)"
                     alt="image"/>
...
<div class="uuDai1">
    ...
    <a href="../ThongTinSanPham_Home/DonghoMiso.html?_ijt=7q3ovei7snfo4cbs535mffetqh">
        <div class="giaoHang">
    ...
    <a href="../ThongTinSanPham_Home/DongHoTabu.html?_ijt=oadff4p4r067mbmq1774jfj5hi">
        <div class="giaoHang">
...
<div id="khungBinhLuan">
    <h3 class="soBinhLuan"> Nhận xét ( 2 Nhận xét )</h3>
    <div class="binhLuan">
    ...
    <div class="binhLuan">
        <div class="noiDungBinhLuan">
            ...
            <div class="thongTinBinhLuan">
                <div class="ChiTiet">
                    <h4 class="tenNguoiBinhLuan1"> Thanh Nhi
                        <i class="fa fa-star" aria-hidden="true"></i>
                        <i class="fa fa-star" aria-hidden="true"></i>
                        <i class="fa fa-star" aria-hidden="true"></i>
                        <i class="fa fa-star" aria-hidden="true"></i>
                ...
                <p class="ngayDang">Đánh giá : Tốt </p>
                <p class="ngayDang">Tiêu Đề : ý tưởng </p>
                <p class="noiDung">Nhân xét : Thiết kế tối giản và tinh tế , mang lại cảm giác trang nhã , tinh tế </p>
            </div>
        </div>
    </div>
</div>
