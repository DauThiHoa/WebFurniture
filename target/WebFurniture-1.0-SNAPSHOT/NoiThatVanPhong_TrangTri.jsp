...
<head>
    ...
    <link rel="icon" href="NoiThatVanPhong/img.png" type="image/png" class="icon">
    <title> NHOM 7 WEB FURNITURE - DANH MỤC SẢN PHẨM - NỘI THẤT VĂN PHÒNG </title>
    <link rel="stylesheet" href="NoiThatVanPhong_TrangTri.css">
...
<div id="Thanh_cong_cu">
    ...
    <form action="ProductDetailsList" >
        ...
        <button id="Tim_Kiem" type="submit" >
            <i style=" font-size : 130% ; margin-top: 3px ; margin-left: 4px" class="fa fa-search" aria-hidden="true"></i>
        </button>
    </form>
    <div id="Hotline">
        <a href="LienHe">
...
<div id="layout1">
    ...
    <div id="right">
        <div id="CacLoaiDoTrangTri">
            ...
            <div class="loai2">
                <a href="NoiThatVanPhong_DenLamViec.jsp?_ijt=k085o4525afcc1aaffmng95bir&_ij_reload=RELOAD_ON_SAVE">
        ...
        <div class="getColor" id="CacSanPham" style="display: ${none}">
            ...
            <c:forEach var="p" items="${getColor}">
                <c:if test="${p.id == 'sp64' || p.id == 'vp13' || p.id == 'sp105' || p.id == 'sp93' || p.id == 'sp99' || p.id == 'sp100' || p.id == 'sp103' || p.id == 'sp106'}" >
                    <div class="sanPham">
        ...
        <div class="searchName" id="CacSanPham" style="display: ${none}">
            ...
            <c:forEach var="p" items="${searchName}">
                <c:if test="${p.id == 'sp64' || p.id == 'vp13' || p.id == 'sp105' || p.id == 'sp93' || p.id == 'sp99' || p.id == 'sp100' || p.id == 'sp103' || p.id == 'sp106'}" >                    <div class="sanPham">
                        <div class="sanPhamNoiThat">
                            <form action="ProductDetails" method="post" >
                                <input type="text" style="display: none" name="id" value="${p.id}">
                                <input style="display: none" type="text" name="name" value="${p.name}">
